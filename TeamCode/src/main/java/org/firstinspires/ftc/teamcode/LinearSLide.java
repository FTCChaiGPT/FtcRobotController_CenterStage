...
import static org.firstinspires.ftc.teamcode.LinearSLide.PropPostition.CENTER;
...
public class LinearSLide extends LinearOpMode {
    ...
    static final double     LINEAR_SLIDE_TICKS = 10 * COUNTS_PER_INCH; //distance * encoder counts_per_inch
...
//                holdHeading(TURN_SPEED, 0, 0.5);
    ...
    public void navigateToBackstage(){
