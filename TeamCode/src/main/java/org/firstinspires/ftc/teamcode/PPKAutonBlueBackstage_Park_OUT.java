...
@Autonomous(name="PPKAutonBlueBackstage_Park_OUT", group = "Auto")
public class PPKAutonBlueBackstage_Park_OUT extends LinearOpMode {
    ...
    private double motorPowerValue = 0.75;
    ...
    private void NavigateToBackstage(PropPostition spikePosition) {
        ...
        switch (spikePosition) {
            case RIGHT:
                ...
                strafe_Left(9,motorPowerValue);
                backward(22, motorPowerValue);
            ...
            case CENTER:
                ...
                backward(18, motorPowerValue);  // this might need to change since the motor specs has been corrected
                telemetry.addLine("Ready for arm");
                telemetry.update();
                arm_backstage(armPowerValue, arm_tic_value);
                break;
            ...
            case LEFT:
                ...
                strafe_Left(9.5F,motorPowerValue);
                telemetry.addLine("Ready for arm");
                telemetry.update();
                arm_backstage(armPowerValue, arm_tic_value);
                break;
            ...
            case CENTER:
                ...
                switch (parkLocation1){
                    ...
                    case OUT:
                        ...
                        telemetry.update();
                        strafe_Right(35
                                , motorPowerValue); //move away from the backstage
                        break;
