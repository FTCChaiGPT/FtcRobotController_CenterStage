...
@Autonomous(name="PPKAutonBluePixel", group = "Auto")
public class PPKAutonBluePixel extends LinearOpMode {
    ...
    private void NavigateToBackstage(PropPostition spikePosition) {
        ...
        switch (spikePosition) {
            case RIGHT:
                ...
                strafe_Right(16,motorPowerValue);
            ...
            case CENTER:
                ...
                strafe_Right(15,motorPowerValue);
                arm_motor.setPower(armPowerValue);
                arm_motor.setTargetPosition((int) Math.round(20 * ARM_DEGREES_PER_TIC));
                arm_motor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                ...
                strafe_Right(22,motorPowerValue);
                telemetry.addLine("Ready for arm");
                telemetry.update();
                arm_backstage(armPowerValue, arm_tic_value);
                break;
            ...
            case LEFT:
                ...
                turn_Left(2,motorPowerValue);
                forward(44,motorPowerValue);
                strafe_Left(33F,motorPowerValue);
            ...
            case LEFT:
                ...
                switch (parkLocation1){
                    case IN:
                        ...
                        telemetry.update();
                        strafe_Left(35, motorPowerValue); //move away from the backstage

                        break;
                    case OUT:
                        telemetry.addLine("Park OUT");
                        telemetry.update();
                        strafe_Right(10, motorPowerValue); //move away from the backstage
                        break;
