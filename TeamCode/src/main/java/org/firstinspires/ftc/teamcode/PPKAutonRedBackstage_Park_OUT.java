...
@Autonomous(name="PPKAutonRedBackstage_Park_OUT", group = "Auto")
public class PPKAutonRedBackstage_Park_OUT extends LinearOpMode {
    ...
    private static final double WRIST_BACKDROP_EXTEND_DROP = .75;
